...
class Settings(BaseSettings):
    ...
    :ivar beta_mode: Skip generation limit checks when True.
    :ivar free_generation_limit: Monthly generation cap when beta_mode is False.
    """
    ...
    beta_mode: bool = True  # Skip generation limit checks when True
    free_generation_limit: int = 3  # Monthly cap when beta_mode is False
